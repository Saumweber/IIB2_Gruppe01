...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `iib2_gruppe1`.`adresse` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `iib2_gruppe1`.`kunde` ;
...
CREATE TABLE IF NOT EXISTS `iib2_gruppe1`.`kunde` (
  ...
  CONSTRAINT `fk_kunde_adresse1`
    ...
    REFERENCES `iib2_gruppe1`.`adresse` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `iib2_gruppe1`.`auftrag` ;
...
START TRANSACTION;
USE `iib2_gruppe1`;
INSERT INTO `iib2_gruppe1`.`adresse` (`id`, `strasse`, `hausnummer`, `plz`, `ort`) VALUES (1, 'Blumenstraße', '13', '10101', 'Entenhausen');
INSERT INTO `iib2_gruppe1`.`adresse` (`id`, `strasse`, `hausnummer`, `plz`, `ort`) VALUES (2, 'Musterstraße', '4', '78934', 'Musterstadt');
...
START TRANSACTION;
USE `iib2_gruppe1`;
INSERT INTO `iib2_gruppe1`.`kunde` (`id`, `name`, `vorname`, `adresse_id`) VALUES (DEFAULT, 'Duck', 'Donald', 1);
INSERT INTO `iib2_gruppe1`.`kunde` (`id`, `name`, `vorname`, `adresse_id`) VALUES (DEFAULT, 'Maus', 'Mickey', 2);
...
INSERT INTO `iib2_gruppe1`.`auftrag` (`id`, `beschreibung`, `erledigt`, `kunde_id`) VALUES (DEFAULT, '4x Blumenerde, 1x Kunstdünger', false, 1);
